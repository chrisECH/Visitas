    ...
    <div class="container-md container-xs centrar">
        <div class="card shadow">
            ...
            <div class="card-body df">
                ...
                <form method="POST" action="{{route('admin.actualizar_solicitud')}}" id="form-solicitud">
                    @csrf
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">  
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control @error('docentePrinc') is-invalid @enderror" name="docentePrinc" id="docentePrinc" value="{{$solicitud->docentePrincipal}}" disabled>
                                @error('docentePrinc')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" class="form-control @error('emailPrinc') is-invalid @enderror" name="emailPrinc" id="emailPrinc" value="{{$solicitud->emailPrincipal}}" disabled>
                                @error('emailPrinc')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('telefonoPrinc') is-invalid @enderror" name="telefonoPrinc" id="telefonoPrinc" value="{{$solicitud->telefonoPrincipal}}" disabled>
                                @error('telefonoPrinc')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="docenteSupl">Docente suplente</label>
