    ...
    <div class="d-flex">
        <div id="sidebar-container" class="bg-primary">
            ...
            <div class="menu">
                ...
                <a href="" class="d-block text-light p-3"><i class="icon ion-md-document mr-2 lead"></i>Consultar estado de solicitudes</a>
                <a href="" class="d-block text-light p-3"><i class="icon ion-md-document mr-2 lead"></i>Ver solicitudes creadas</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="#">Consultar estado de solicitudes</a>
                                <a class="dropdown-item" href="#">Ver solicitudes creadas</a>
